...
async function sendEmailNotification(email, type, data) {
	logger.info(`sendEmailNotificationLetter: ${JSON.stringify({ email, type, data }, null, 2)}`);
...
async function sendTelegramNotification(message, level = "error", metadata = {}, options = {}) {
	try {
