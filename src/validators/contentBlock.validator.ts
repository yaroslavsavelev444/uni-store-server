...
// Схема кнопки
const buttonSchema = Joi.object<Button>({
...
// Полная схема для создания/валидации
export const contentBlockSchema = Joi.object<ContentBlock>({
...
export const idSchema = Joi.object<IdParam>({
  id: Joi.string()
