...
const emailSchema = object({
	type: string().valid("support", "info", "sales", "security", "hr", "other").default("general"),
...
const socialLinkSchema = object({
	platform: string().valid("telegram", "vk", "github", "max", "other").required(),
...
const otherContactSchema = object({
	type: string().valid("messenger", "forum", "custom", "chat", "bot").required(),
