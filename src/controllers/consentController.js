...
import { createConsentSchema, updateConsentSchema } from "../validators/consent.validators";
...
class ConsentController {
	async create(req, res, next) {
		try {
			...
			const { title, slug, description, content, isRequired, needsAcceptance, documentUrl } =
				req.body;
	...
	async getForRegistration(_req, res, next) {
		try {
	...
	async getRequiredForAcceptance(_req, res, next) {
		try {
