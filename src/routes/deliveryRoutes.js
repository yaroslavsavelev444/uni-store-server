...
// Админские роуты
router.post("/pickup-points", authMiddleware("admin"), pickupPointController.createPickupPoint);

router.put("/pickup-points/:id", authMiddleware("admin"), pickupPointController.updatePickupPoint);
