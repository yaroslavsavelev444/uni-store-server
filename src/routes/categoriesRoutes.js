...
router.get("/list", validateCategoryQuery(categoryListQuerySchema), getCategoryList);
...
router.put("/:id", validateObjectId("id"), validateCategory(updateCategorySchema), updateCategory);
