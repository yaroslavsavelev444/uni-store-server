...
router.post("/", validationMiddleware(refundSchemas.createRefund), refundController.createRefund);

router.get("/my", refundController.getUserRefunds);

router.get("/my/:id", refundController.getRefundById);
