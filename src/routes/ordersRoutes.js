...
router.post("/:id/cancel", authMiddleware("user"), ordersController.cancelOrder);

// ========== ADMIN ROUTES ==========
router.get("/admin/orders", authMiddleware("admin"), ordersController.getAdminOrders);

router.get("/admin/orders/:id", authMiddleware("admin"), ordersController.getAdminOrder);
...
router.post("/admin/orders/:id/cancel", authMiddleware("admin"), ordersController.cancelOrderAdmin);
