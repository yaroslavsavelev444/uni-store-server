...
export const jobs = {
	...
	feedbackCleanup: {
		...
		retentionDays: parseInt(process.env.FEEDBACK_RETENTION_DAYS, 10) || 365,
	},
	diskMonitor: {
		schedule: process.env.CRON_DISK_MONITOR || "0 * * * *", // Каждый час
		enabled: process.env.CRON_DISK_MONITOR_ENABLED !== "false",
		maxSizeMB: parseInt(process.env.MAX_UPLOADS_SIZE_MB, 10) || 1024,
		alertThreshold: parseInt(process.env.DISK_ALERT_THRESHOLD, 10) || 90,
	},
};
...
export const logLevel = process.env.CRON_LOG_LEVEL || "info";
